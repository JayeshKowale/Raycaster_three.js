...
// const pointMaterial = new THREE.PointsMaterial({color:"grey", size: 0.4});
...
//     newpoint2.position.copy(closestPointInPolygon(verticess1,mouse));
...
// call updatePointPosition function to update the point's position on mouse move
// window.addEventListener('mousemove', onDocumentMouseMove, false);
// document.addEventListener('mousemove', updatePointPosition);
...
//   }
        ...
        // check if point is inside polygon using raycasting
...
///////////////////////////////////////////////
 ...
 // Call closestPointInPolygon with the current mouse position in a loop
...
//  document.addEventListener('mousemove', updatePointPosition);
  ...
  function render() {
    ...
    //document.addEventListener('mousemove', updatePointPosition);
   //const closestPoint = closestPointInPolygon(poly_vertices, mouse);
    // Do something with the closest point, e.g. update the position of a point
    //console.log(closestPoint);
    //npoint.position.copy(closestPoint);
